...
import { ErrorLegend } from "../src/components";
import type { ErrorLegendProps } from "../src/components";

export default {
	title: "AllComponents/ErrorLegend",
	component: ErrorLegend,
} as ComponentMeta<typeof ErrorLegend>;

const Template = (args: ErrorLegendProps) => <ErrorLegend {...args} />;
